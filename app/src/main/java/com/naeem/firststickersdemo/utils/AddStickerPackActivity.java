...
import com.naeem.firststickersdemo.BaseActivity;
...
public abstract class AddStickerPackActivity extends BaseActivity {
    ...
    private Intent createIntentToAddStickerPack(String identifier, String stickerPackName) {
        ...
        intent.putExtra(Constants.EXTRA_STICKER_PACK_ID, identifier);
        intent.putExtra(Constants.EXTRA_STICKER_PACK_AUTHORITY, BuildConfig.CONTENT_PROVIDER_AUTHORITY);
        intent.putExtra(Constants.EXTRA_STICKER_PACK_NAME, stickerPackName);
        return intent;
    }
